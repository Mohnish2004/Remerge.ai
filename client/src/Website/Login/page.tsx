...
const Login = () => {
    ...
    return (
        <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-white lg:flex">
                ...
                <div>
                    <img src="/images/Login/n.png" className="w-[900px] h-[618px] left-[18px] absolute top-0" alt="Small Image"/>
                </div>
            </div>
    ...
    <div className="w-full max-w-md space-y-5 px-4 bg-white text-gray-900 sm:px-0">
                    ...
                    <div className="grid grid-cols-3 gap-x-3">
                        <button id = "googleButton" className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
