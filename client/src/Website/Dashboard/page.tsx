...
export default function Example() {
  return (
    <body className="bg-gray-50 dark:bg-white">

  <div className="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 md:px-8 lg:hidden dark:bg-white dark:border-bg-white">
  ...
  <div id="application-sidebar" className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-white dark:border-white">
    <div className="px-6">
    <img className="h-8 w-auto" src="/images/logo.png" alt=""></img>
    </div>

    <nav className="hs-accordion-group p-6 w-full flex flex-col relative flex-wrap" data-hs-accordion-always-open>
    <button type="button" className="rounded-lg border border-gray-700 bg-black px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-gray-900 hover:bg-gray-900 focus:ring focus:ring-gray-200 disabled:cursor-not-allowed disabled:border-gray-300 disabled:bg-gray-300">Create New</button>
    <div className='py-2'></div>
      <ul className="space-y-1.5">
        <li>
          <a className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-black rounded-md hover:bg-gray-100 dark:bg-white0 dark:hover:bg-gray-100 dark:text-black dark:hover:text-black dark:hs-accordion-active:text-white" href="javascript:;">
        ...
        <li className="hs-accordion" id="users-accordion">
          <a className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-black rounded-md hover:bg-gray-100 dark:bg-white0 dark:hover:bg-gray-100 dark:text-black dark:hover:text-black dark:hs-accordion-active:text-white" href="javascript:;">
            ...
            <svg className="hs-accordion-active:block ml-auto hidden w-3 h-3 text-gray-900 group-hover:text-gray-500 dark:text-gray-400" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <li><a className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-black rounded-md hover:bg-gray-100 dark:bg-white0 dark:hover:bg-gray-100 dark:text-black dark:hover:text-black dark:hs-accordion-active:text-white" href="javascript:;">
          <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  ...
  {/* Background */}
  <div className="absolute top-3 left-[auto] right-[10px] max-w-[100%] w-[1160px] h-[995px] bg-zinc-100 rounded-3xl z-0" />

  {/* Content */}
  <div className="w-full pt-10 px-10 sm:px-10 md:px-10 lg:pl-72 relative z-10">
    Welcome Mohnish
    <header>
      <p className="mb-2 text-sm font-semibold text-blue-600">my profile card can go here </p>
      <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-black">I can put the main heading here</h1>
      <p className="mt-2 text-lg text-gray-800 dark:text-gray-800">and maintain this size for everything else</p>
    </header>
    <br></br>
    <Edit/>
  </div>
