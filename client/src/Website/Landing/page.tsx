...
=======
  ...
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    <div className="mb-8 md:mb-12">
      <h2 className="mb-4 text-center text-2xl font-semibold text-gray-800 md:mb-6 lg:text-3xl">Our Team by the numbers</h2>
    </div>
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:gap-8">
      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-100 p-4 lg:p-8">
        <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">{'>'}5</div>
      ...
      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-100 p-4 md:p-8">
        <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">1</div>
        <div className="text-sm font-semibold sm:text-base">Crackhead</div>
      </div>

      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-100 p-4 md:p-8">
        <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">1</div>
        <div className="text-sm font-semibold sm:text-base">South Indian</div>
      </div>
      <div className="flex flex-col items-center justify-center rounded-lg bg-gray-100 p-4 md:p-8">
        <div className="text-xl font-bold text-indigo-500 sm:text-2xl md:text-3xl">3</div>
        <div className="text-sm font-semibold sm:text-base">Gujuratis</div>
      </div>
    </div>
  </div>
</div>
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    ...
    <div>
      <img className="rounded-xl" src="/images/Landing/feature1.png" />
    </div>
  </div>
</div>
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div>
      <img className="rounded-xl" src="/images/Landing/feature2.png" />
    </div>
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    ...
    <div>
      <img className="rounded-xl" src="/images/Landing/feature3.png" />
    </div>
  </div>
</div>
        ...
        <div className="text-center">
                <h1 className="text-4xl py-3 font-regular tracking-tight text-gray-900 sm:text-6xl">
                  Our Pricing
                </h1>
                <p>Start free and expand while you grow. No hidden fees. </p>
                </div>
      ...
      <div className="relative p-10 space-y-12 overflow-hidden lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8 rounded-xl">
        <div className="relative flex flex-col p-8 bg-white">
          <div className="flex-1">
            <h3 className="text-xl font-semibold text-neutral-600">Basic Plan</h3>
            <p className="flex items-baseline mt-4 text-black">
              <span className="text-5xl font-extrabold tracking-tight text-black">FREE</span>
              <span className="ml-1 text-xl font-semibold text-black">/month</span>
            </p>
            <p className="mt-6 text-gray-500">The essentials to provide you to explore</p>
            <ul role="list" className="pt-6 mt-6 space-y-6 border-t">
              ...
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-gray-600 rounded-xl">
                ...
                <span className="ml-3 text-neutral-600">15 different roles</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-gray-600 rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-neutral-600">Track upto 3 old versions</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-gray-600 rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-neutral-600">Limited Directories</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-gray-600 rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-neutral-600">Organize, delegate and keep track of tasks</span>
              </li>
            </ul>
          </div>
          <div className="mt-6 rounded-lg">
            <a href="#" type="highlight" className="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-indigo-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 bg-white"> Get Started </a>
          </div>
        </div>
        <div className="relative flex flex-col p-8 bg-gray-200 rounded-2xl">
          <div className="relative flex-1">
            <h3 className="text-xl font-semibold text-black">Startup</h3>
            <p className="flex items-baseline mt-4 text-black">
              <span className="text-5xl font-extrabold tracking-tight text-black">$69.99</span>
              <span className="ml-1 text-xl font-semibold text-black">/month</span>
            </p>
            <p className="mt-6 text-black text-solitud">A plan that scales with your rapidly growing business.</p>
            <ul role="list" className="pt-6 mt-6 space-y-6 border-t">
              <span className="text-lg font-semibold text-black">What's included?</span>
              <li className="flex">
                ...
                <span className="ml-3 text-black">Data-driven AI Suggestions</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-white rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-neutral-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-black">Data visualisation</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-white rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-neutral-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-black">New Templates </span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-white rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-neutral-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-black">Multiple Collaborators</span>
              </li>
              <li className="flex">
                <div className="inline-flex items-center w-6 h-6 bg-white rounded-xl">
                  <svg className="flex-shrink-0 w-4 h-4 mx-auto text-neutral-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <span className="ml-3 text-black">Other Intergratsions</span>
              </li>
            </ul>
          </div>
          <div className="z-50 mt-6 rounded-lg">
            <a href="/pricing" type="highlight" className="w-full items-center block px-10 py-3.5 text-base font-medium text-center text-indigo-600 transition duration-500 ease-in-out transform border-2 border-white shadow-md rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 bg-white"> Get started </a>
          </div>
        </div>
      </div>
    </div>
