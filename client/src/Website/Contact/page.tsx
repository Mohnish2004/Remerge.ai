...
export default function Example() {
  return (
    <div className="w-[1318px] h-[735px] right-[-50px] relative bg-zinc-100 rounded-3xl">
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
      <div className="max-w-2xl lg:max-w-5xl mx-auto">
        <div className="text-center">
          <h1 className="text-6xl font-semi text-gray-800 sm:text-7xl">
            Contact us
          </h1>
            ...
            <form>
              <div className="grid gap-4">
                ...
                <div>
                  ...
                  <textarea id="hs-about-contacts-1" name="hs-about-contacts-1" className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 " placeholder="Details"></textarea>
                </div>
              </div>
